...
cs_non_dac_350 <- 1/2*((158034.280239 - non_dac_q_350)*non_dac_q_350)
cs_non_dac_350
#1992220757
...
cs_non_dac_400 <- 1/2*((158034.280239 - non_dac_q_400)*non_dac_q_400)
cs_non_dac_400
#1936729801
...
cs_non_dac_450 <- 1/2*((158034.280239 - non_dac_q_450)*non_dac_q_450)
cs_non_dac_450
#1879908388
...
cs_non_dac_500 <- 1/2*((158034.280239 - non_dac_q_500)*non_dac_q_500)
cs_non_dac_500
#1821756516
...
welfare w/ redistribution @ \$400: \$2,671,935,932        <br>
welfare w/ redistribution @ \$450: \$2,670,214,401          <br>
welfare w/ redistribution @ \$500: \$2,658,984,439       <br>
...
welfare w/ redistribution @ \$350:-\$ + .2036($) =     <br>
welfare w/ redistribution @ \$400:-\$ + .2036($) =    <br>
welfare w/ redistribution @ \$450:-\$ + .2036($) =     <br>
welfare w/ redistribution @ \$500: -\$ + .2036($) =    <br>
...
```{r}
.## 350
ps_350 <- 1/2*68900*39892.16
```

```{r}
## 400
ps_400 <- 1/2*68900*39892.16
```

```{r}
## 450
ps_450 <- 1/2*68900*39892.16
```


```{r}
## 500
ps_500 <- 1/2*68900*39892.16
```
